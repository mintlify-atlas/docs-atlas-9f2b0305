...
<CardGroup cols={2}>
  ...
  <Card title="Connecting Stores" icon="plug" href="/connecting-stores">
    Link Steam, GOG, PlayStation, Epic, and nine more storefronts with one-click sign-in.
  </Card>
...
| **PlayStation (PSN)** | Library via your NPSSO session token. Requires trophy and game privacy set to Anyone. |
