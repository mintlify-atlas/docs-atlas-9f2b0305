...
description: "All Baklog environment variables and server options. Prefer the Connections tab — .env is legacy and auto-imported into the encrypted store on first run."
---
